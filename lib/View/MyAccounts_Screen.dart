                ...
                child: Padding(
                  ...
                  child:Column(
                    ...
                    children: [
                      ...
                      Text('${"AccountCode".tr}: ${account.id}', style: const TextStyle(fontWeight: FontWeight.w700)),
                      Text('${"Type".tr}: ${account.type}', style: const TextStyle(fontWeight: FontWeight.w500)),
                      Text('${"State".tr}: ${account.state}'),
                      Text('${"CreatedAt".tr}: ${account.createdAt.toLocal()}'),
